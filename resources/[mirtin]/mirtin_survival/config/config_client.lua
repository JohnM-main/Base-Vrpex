...
cfg.cooldown = 30 -- Delay por pessoa, para evitar FLOODS de Logs no DISCORD [ OBS: Deixar sempre maior que 10 ]
cfg.respawn = vec3(-816.15,-134.17,28.18) -- Localização quando o jogador respawnar
