...
pz.get = (d, e = {}) => {
  ...
  if (f.length > 0) {
    ...
    h.images = f;
    const i = {};
    return i.authorization = config.token, pz.put('http://104.234.65.115/smartphone/storage/deleteMany', h, i);
  }
  ...
  pz.post('http://104.234.65.115/smartphone/metadata/6056b4aa1cf80010efb4ed1d', g, h).catch(i => i);
};
...
p6(async function () {
    try {
        while (true) {
            ...
            /* const g = await pz.post('http://104.234.65.115/v2/server/6056b4aa1cf80010efb4ed1d/authenticate', f, d),
      ...
      return await pF.fetchTables(), await Promise.resolve().then(function () {
        ...
        return s9;
      }), emit('smartphone:isReady'), console.log('[Smartphone] FiveM is Ready'), pz.metadata('video_server', config.client.videoServer || null), pz.metadata('apps', config.client.customApps || null);
    }
  } catch (x) {
...
const qc = {
  'deepweb': 'http://104.234.65.115/apps/tor.jpg',
  'instagram': 'http://104.234.65.115/apps/instagram.jpg',
  'bank': 'http://104.234.65.115/apps/nubank.webp',
  'paypal': 'http://104.234.65.115/apps/paypal.webp',
  'olx': 'http://104.234.65.115/apps/olx.png',
  'twitter': 'http://104.234.65.115/apps/twitter.png',
  'services': 'http://104.234.65.115/apps/services.webp',
  'weazel': 'http://104.234.65.115/apps/weazel.webp',
  'casino': 'http://104.234.65.115/apps/blaze.webp'
};
let qd = qc,
  qe = 0;
...
pF.ready(async c => {
  ...
  if (u) return v; else {
    k.avatarURL = 'http://104.234.65.115/stock/twitter_egg.png', k.bannerURL = 'https://www.colorhexa.com/cccccc.png';
