...
CREATE DATABASE IF NOT EXISTS `vrpex` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `vrpex`;

-- Copiando estrutura para tabela vrpex.bm_chamados
...
-- Copiando dados para a tabela vrpex.bm_chamados: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela vrpex.bm_daily
...
-- Copiando dados para a tabela vrpex.bm_daily: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela vrpex.bm_dealership
...
-- Copiando dados para a tabela vrpex.bm_dealership: ~573 rows (aproximadamente)
INSERT IGNORE INTO `bm_dealership` (`vehicle`, `stock`) VALUES
	('14r8', 0),
	('180sx', 0),
	('18macan', 0),
	('18performante', 0),
...
-- Copiando estrutura para tabela vrpex.bm_registration
...
-- Copiando dados para a tabela vrpex.bm_registration: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela vrpex.clothes
...
-- Copiando dados para a tabela vrpex.clothes: ~2 rows (aproximadamente)
INSERT IGNORE INTO `clothes` (`name`, `permiss`, `service`, `custom`, `sexo`) VALUES
...
-- Copiando estrutura para tabela vrpex.eg_reward
...
-- Copiando dados para a tabela vrpex.eg_reward: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela vrpex.fstore_appointments
...
-- Copiando dados para a tabela vrpex.fstore_appointments: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela vrpex.mirtin_bans
...
-- Copiando dados para a tabela vrpex.mirtin_bans: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela vrpex.mirtin_bans_hwid
...
-- Copiando dados para a tabela vrpex.mirtin_bans_hwid: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela vrpex.mirtin_chamados
...
-- Copiando dados para a tabela vrpex.mirtin_chamados: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela vrpex.mirtin_homes
...
-- Copiando dados para a tabela vrpex.mirtin_homes: ~518 rows (aproximadamente)
INSERT IGNORE INTO `mirtin_homes` (`id`, `tipo`, `price`, `coords`, `garagem`, `chaves`, `minBau`, `maxMoradores`, `permissao`, `interior`) VALUES
...
-- Copiando estrutura para tabela vrpex.mirtin_orgs
...
-- Copiando dados para a tabela vrpex.mirtin_orgs: ~56 rows (aproximadamente)
INSERT INTO `mirtin_orgs` (`org`, `membros`, `maxMembros`, `anotacao`, `banco`, `bancoHistorico`) VALUES
	...
	('Policia', '{}', 999, NULL, 0, NULL),
	('PoliciaCivil', '{}', 999, NULL, 0, NULL),
	('Roxos', '{}', 999, NULL, 0, NULL),
...
-- Copiando estrutura para tabela vrpex.mirtin_users_homes
...
-- Copiando dados para a tabela vrpex.mirtin_users_homes: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela vrpex.nation_concessionaria: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela vrpex.smartbank_accounts
...
-- Copiando dados para a tabela vrpex.smartbank_accounts: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela vrpex.smartbank_cards
...
-- Copiando dados para a tabela vrpex.smartbank_cards: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela vrpex.smartbank_statements
...
-- Copiando dados para a tabela vrpex.smartbank_statements: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela vrpex.trafico
CREATE TABLE IF NOT EXISTS `trafico` (
  `user_id` text NOT NULL,
  PRIMARY KEY (`user_id`(765))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Copiando dados para a tabela vrpex.trafico: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela vrpex.vrp_colect
...
-- Copiando dados para a tabela vrpex.vrp_colect: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela vrpex.vrp_srv_data: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela vrpex.vrp_users: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela vrpex.vrp_users_infos
...
-- Copiando dados para a tabela vrpex.vrp_users_infos: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela vrpex.vrp_user_data: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela vrpex.vrp_user_identities: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela vrpex.vrp_user_ids: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela vrpex.vrp_user_veiculos
...
-- Copiando dados para a tabela vrpex.vrp_user_veiculos: ~0 rows (aproximadamente)
